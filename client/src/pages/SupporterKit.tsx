...
const PRODUCT_CATALOG = {
  tee:  { id: "tee",  title: "Official Tournament Tee",  price: "$29.99", mockupImg: "/images/white-tee.png", defaultWidth: 200, defaultHeight: 110, initialX: 135, initialY: 180, desc: "Premium heavyweight organic cotton. Vintage unisex tailored boxy fit." },
  tote: { id: "tote", title: "Host City Canvas Tote",     price: "$19.99", mockupImg: "/images/tote.png",      defaultWidth: 180, defaultHeight: 160, initialX: 145, initialY: 160, desc: "100% certified organic cotton canvas. Ultra-durable heavy duty straps." },
  cap:  { id: "cap",  title: "Match-Day Retro Cap",       price: "$24.99", mockupImg: "/images/cap.png",       defaultWidth: 100, defaultHeight: 45,  initialX: 185, initialY: 200, desc: "Classic low-profile unstructured dad hat. Enzyme-washed premium twill." },
};
